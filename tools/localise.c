...
static const char* const es[][2] = {
    ...
    {"I'm Franco Gutiérrez. I study Computer Science and Engineering at "
     "the\n**University of Chile**, in the Department of Computer "
     "Science\n(**DCC**) of the Faculty of Physical and Mathematical "
     "Sciences\n(**FCFM**).",
     "Soy Franco Gutiérrez. Estudio Ingeniería Civil en Computación en "
    ...
    {"<b>Faculty</b></td><td>Faculty of Physical and Mathematical Sciences "
     "(FCFM)<",
     "<b>Facultad</b></td><td>Facultad de Ciencias Físicas y Matemáticas "
     "(FCFM)<"},
    {"<b>University</b></td><td>University of Chile<",
     "<b>Universidad</b></td><td>Universidad de Chile<"},
    {"## Computing", "## Computación"},
    {"<b>Systems</b>", "<b>Sistemas</b>"},
    {"<b>Working with</b>", "<b>Trabajando con</b>"},
    ...
    {"A terminal colour palette on a warm neutral ramp, as Base16 and "
     ...
     "Una paleta de color para terminal sobre una rampa neutra cálida, "
    ...
    {"alt=\"Lightning address as a QR code\"",
     "alt=\"Dirección de Lightning en código QR\""},
    {"alt=\"Ethereum address as a QR code\"",
     "alt=\"Dirección de Ethereum en código QR\""},
    {"alt=\"Bitcoin over Lightning\"", "alt=\"Bitcoin por Lightning\""},
    {"<summary>You can support my public work through Liberapay or "
     "cryptocurrency. <b>Monero preferred.</b></summary>",
     "<summary>Puede apoyar mi trabajo público a través de Liberapay o "
     "criptomonedas. <b>Monero de preferencia.</b></summary>"},
    ...
    {"label=Issues", "label=Incidencias"},
    {"label=Threads", "label=Hilos"},
    {"label=Comments", "label=Comentarios"},
    {"label=Commits", "label=Confirmaciones"},
    {"label=Pull%20requests", "label=Solicitudes"},
    {"alt=\"Issues opened\"", "alt=\"Incidencias abiertas\""},
    {"alt=\"Threads taken part in\"", "alt=\"Hilos en los que participa\""},
    {"alt=\"Threads commented on\"", "alt=\"Hilos comentados\""},
    {"alt=\"Commits authored\"", "alt=\"Confirmaciones escritas\""},
    {"alt=\"Pull requests opened\"", "alt=\"Solicitudes abiertas\""},
...
static const char* const la[][2] = {
    {"Computer Science and Engineering student at the University of Chile "
     ...
     "Discipulus scientiae computatralis in Universitate Chilensi "
     "(DCC/FCFM).**\n\n*Studens systematibus, fonti aperto, systematibus "
     "generis Unix et arti ingeniariae programmaturae.*"},
    {"## About", "## De me"},
    {"I'm Franco Gutiérrez. I study Computer Science and Engineering at "
     "the\n**University of Chile**, in the Department of Computer "
     "Science\n(**DCC**) of the Faculty of Physical and Mathematical "
     "Sciences\n(**FCFM**).",
     "Franco Gutiérrez sum. Scientiae computatrali in "
     "**Universitate\nChilensi** studeo, in Departimento Scientiarum "
     "Computatralium (**DCC**)\nFacultatis Scientiarum Physicarum et "
     "Mathematicarum (**FCFM**)."},
    {"My main interests are systems, free and open-source "
     "software,\nUnix-like operating systems, and software engineering. I "
     "tend to work\nfrom the shell, primarily with **Neovim**.",
     "Praecipue me tenent systemata, programmatura libera et "
     "aperta,\nsystemata operandi generis Unix, et ars ingeniaria "
     "programmaturae.\nPlerumque e cortice imperatorio laboro, **Neovim** "
     "utens."},
    {"## Currently", "## Nunc"},
    {"My studies at the [**University of Chile**](https://uchile.cl/) are "
     "my\nprimary focus, alongside personal software projects and my work "
     "at\n[**Venturas**](https://venturas.cl/).",
     "Studia mea in [**Universitate Chilensi**](https://uchile.cl/) "
     "praecipua\nmihi cura sunt, simul cum operibus programmaturae "
     "propriis et labore meo\napud [**Venturas**](https://venturas.cl/)."},
    {"## University\n", "## Universitas\n"},
    {"<b>Degree</b></td><td>Computer Science and Engineering<",
    ...
    {"<b>Faculty</b></td><td>Faculty of Physical and Mathematical Sciences "
     "(FCFM)<",
     "<b>Facultas</b></td><td>Scientiarum physicarum et mathematicarum "
     "(FCFM)<"},
    {"<b>University</b></td><td>University of Chile<",
     "<b>Universitas</b></td><td>Universitas Chilensis<"},
    {"## Computing", "## Computatio"},
    {"<b>Editor</b>", "<b>Scriptorium</b>"},
    {"<b>Systems</b>", "<b>Systemata</b>"},
    {"<b>Working with</b>", "<b>In manibus</b>"},
    {"<b>Web &amp; markup</b>", "<b>Tela et notatio</b>"},
    {"## Projects", "## Opera"},
    {"Advanced Gentoo installation documentation for AMD64 musl systems, "
     "covering\nOpenRC, LUKS2, Btrfs, LLVM/Clang, ThinLTO, and the Zen "
     "kernel.",
     "Scriptura provecta de institutione Gentoo in systematibus musl et "
     "AMD64,\nquae OpenRC, LUKS2, Btrfs, LLVM/Clang, ThinLTO et nucleum "
     "Zen complectitur."},
    {"A terminal colour palette on a warm neutral ramp, as Base16 and "
     "Base24\nschemes, in seventeen variants.",
     "Pales colorum pro terminali super scalam neutram calidam, ut "
     "rationes\nBase16 et Base24, in septendecim formis."},
    {"alt=\"The alchemical sign of phosphorus\"",
     "alt=\"Signum alchemicum phosphori\""},
    {"[**All public repositories →**]", "[**Omnia repositoria publica →**]"},
    {"## Enterprises", "## Negotia"},
    {"Where I keep my commercial projects.", "Ubi opera mea mercatoria servo."},
    {"## Contact", "## Epistulae"},
    {"stamps/futbol.gif\" width=\"99\" height=\"56\" alt=\"Football\"",
     "stamps/futbol-la.gif\" width=\"99\" height=\"56\" alt=\"Pediludium\""},
    {"stamps/foss.gif\" width=\"99\" height=\"56\" alt=\"Free software\"",
     "stamps/foss-la.gif\" width=\"99\" height=\"56\" alt=\"Programmata "
     "libera\""},
    {"badges/email.svg\" height=\"20\" alt=\"Email\"",
    ...
    {"Email is the best way to reach me. I answer as soon as I can.",
     "Epistula optima via est ad me contingendum. Respondeo cum primum "
     "possum."},
    {"The Ethereum address takes ETH, USDC and USDT on Ethereum itself "
     "too.",
     "Inscriptio Ethereum quoque accipit ETH, USDC et USDT in ipsa rete "
     "Ethereum."},
    {"alt=\"Monero address as a QR code\"",
     "alt=\"Inscriptio Monero in codice QR\""},
    {"alt=\"Lightning address as a QR code\"",
     "alt=\"Inscriptio Lightning in codice QR\""},
    {"alt=\"Ethereum address as a QR code\"",
     "alt=\"Inscriptio Ethereum in codice QR\""},
    {"alt=\"Bitcoin over Lightning\"", "alt=\"Bitcoin per Lightning\""},
    {"<summary>You can support my public work through Liberapay or "
     "cryptocurrency. <b>Monero preferred.</b></summary>",
     "<summary>Opus meum publicum per Liberapay vel per nummos "
     "cryptographicos sustinere potes. <b>Monero praelatum.</b></summary>"},
    ...
    {"label=Issues", "label=Quaestiones"},
    {"label=Threads", "label=Colloquia"},
    {"label=Comments", "label=Commentarii"},
    {"label=Commits", "label=Commissa"},
    {"label=Pull%20requests", "label=Petitiones"},
    {"alt=\"Issues opened\"", "alt=\"Quaestiones apertae\""},
    {"alt=\"Threads taken part in\"", "alt=\"Colloquia quibus interfuit\""},
    {"alt=\"Threads commented on\"", "alt=\"Colloquia commentata\""},
    {"alt=\"Commits authored\"", "alt=\"Commissa scripta\""},
    {"alt=\"Pull requests opened\"", "alt=\"Petitiones apertae\""},
...
static const char* const selectors[3] = {
    ...
    "align=\"texttop\"> **[Español](../es/README.md)** · <img "
    "src=\"../../assets/flags/england.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **English**",
    "<img src=\"../../assets/flags/spqr.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **[Latine](../la/README.md)** · <img "
    "src=\"../../assets/flags/burgundy.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **Español** · <img "
    "src=\"../../assets/flags/england.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **[English](../en/README.md)**",
    "<img src=\"../../assets/flags/spqr.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **Latine** · <img "
    "src=\"../../assets/flags/burgundy.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **[Español](../es/README.md)** · <img "
    "src=\"../../assets/flags/england.svg\" alt=\"\" height=\"18\" "
    "align=\"texttop\"> **[English](../en/README.md)**"
