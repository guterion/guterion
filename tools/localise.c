...
static const char *const ES[][2] = {
	...
	{ "alt=\"Bitcoin over Lightning\"",
	  "alt=\"Bitcoin por Lightning\"" },
	...
	{ "alt=\"Threads taken part in\"",
	  "alt=\"Hilos en los que participa\"" },
	{ "alt=\"Threads commented on\"",
	  "alt=\"Hilos comentados\"" },
	{ "alt=\"Commits authored\"",
	  "alt=\"Confirmaciones escritas\"" },
...
static const char *const LA[][2] = {
	...
	{ "alt=\"Threads taken part in\"",
	  "alt=\"Colloquia quibus interfuit\"" },
	{ "alt=\"Threads commented on\"",
	  "alt=\"Colloquia commentata\"" },
	{ "alt=\"Commits authored\"",
	  "alt=\"Commissa scripta\"" },
	{ "alt=\"Pull requests opened\"",
